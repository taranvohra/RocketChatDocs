...
{% hint style="info" %}
You can learn how to install and enable each of them in the [App Guide](https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace/rocket.chat-public-apps-guides).
{% endhint %}
...
If you are looking for the manual/user guide of a particular app, check [https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace/rocket.chat-public-apps-guides](https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace/rocket.chat-public-apps-guides "mention") or search for it within the documentation.
