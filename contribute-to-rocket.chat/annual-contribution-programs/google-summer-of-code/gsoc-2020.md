...
Over the next month, our mentors will be reviewing the received proposals. Google Summer of Code will be announcing the selected projects and students on May 4th, 2020. Please see [GSoC timeline](gsoc-2020.md#timeline) for more details.
...
For ideas, check out our growing [list of ideas](gsoc-2020.md#project-ideas) for some inspiration.
