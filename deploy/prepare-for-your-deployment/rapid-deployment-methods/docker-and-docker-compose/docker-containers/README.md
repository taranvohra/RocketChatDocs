...
First, make sure [UFW](https://en.wikipedia.org/wiki/Uncomplicated_Firewall) (Uncomplicated FireWall) is installed. It should be installed by default in Ubuntu, but if it’s not, you can check if it is installed by running.
...
Follow this guide [https://docs.docker.com/linux/step\_one/](https://docs.docker.com/linux/step_one/) to get Docker installed.
