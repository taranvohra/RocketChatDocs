...
Here is a link to a [Nginx multi instance reverse proxy example](https://github.com/taranvohra/RocketChatDocs/blob/master/deploy-rocket.chat/rocket.chat-environment-configuration/broken-reference/README.md)
