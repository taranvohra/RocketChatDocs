...
\*\*\*\*[**Deploying multiple instances of Rocket.Chat:** ](https://github.com/taranvohra/RocketChatDocs/blob/master/deploy-rocket.chat/scaling-rocket.chat/broken-reference/README.md)Running multiple instances of the Rocket.Chat application on a multi-core machine.
