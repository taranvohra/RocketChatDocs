...
{% hint style="info" %}
We recommend you register your workspace, which automatically creates a [Rocket.Chat Cloud Account](https://github.com/taranvohra/RocketChatDocs/blob/master/setup-and-administer-rocket.chat/accessing-your-workspace/broken-reference/README.md) for you, and you can enjoy all its benefits like;

* Mobile [**push notifications**](../../use-rocket.chat/rocket.chat-mobile/push-notifications/)**.**
* [**Omnichannel**](../../use-rocket.chat/omnichannel/)
* Access to [**marketplace apps**](https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace).
{% endhint %}
