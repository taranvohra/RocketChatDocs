...
| `app`         | Automated users that are used by Rocket.Chat Apps from the [https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace](https://github.com/taranvohra/RocketChatDocs/blob/master/extend-rocket.chat-capabilities/rocket.chat-marketplace "mention")           |
