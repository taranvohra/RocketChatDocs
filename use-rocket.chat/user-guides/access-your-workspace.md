...
* After entering a valid Rocket.Chat workspace address the [registration](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/user-guides/broken-reference/README.md) page appears. If you have already registered, enter your credentials to log in or click **Register a new account** to become a member of that workspace
