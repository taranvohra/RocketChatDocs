...
* Teams can have [Auto-join channels](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/user-guides/rooms/teams/broken-reference/README.md) where members are automatically added to, upon joining the team.
