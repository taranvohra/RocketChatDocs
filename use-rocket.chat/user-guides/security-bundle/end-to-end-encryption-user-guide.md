...
To convert an existing room to an encrypted room, it must be a [private room](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/user-guides/security-bundle/broken-reference/README.md)
