...
_Note:_ Google Drive features available only if the server's admin has enabled Google Drive access and provided the correct API keys. For instructions to obtain these keys can see the [Administrator guides](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/user-guides/messages/broken-reference/README.md).
