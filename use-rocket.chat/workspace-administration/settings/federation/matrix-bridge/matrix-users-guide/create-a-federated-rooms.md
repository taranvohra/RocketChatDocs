...
Using [Multi Direct Message](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/matrix-bridge/matrix-users-guide/broken-reference/README.md), you can send Direct Messages to multiple users(federated or not) at once.

To create a federated Multi Direct Message:

* [Create a Multi-user Direct Message](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/matrix-bridge/matrix-users-guide/broken-reference/README.md)
