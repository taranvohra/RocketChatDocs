...
Rocket.Chat provides Federation using the [Matrix Protocol](https://matrix.org/) and the [Rocket.Chat Federation Network](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/rocket.chat-federation) (Will be deprecated on 6.0.0).
...
\*\*\*\*[**Rocket.Chat Federation**](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-federation): Learn how to federate with Rocket.Chat basic federation.
