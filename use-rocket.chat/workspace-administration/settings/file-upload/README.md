...
You can find a more detailed guide on how to set up your Amazon S3 server [here](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/settings/file-upload/broken-reference/README.md).
...
The settings used when configuring a Google Cloud Storage server. You can find more details [here](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/settings/file-upload/broken-reference/README.md).
