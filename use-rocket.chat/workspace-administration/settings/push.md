...
{% content-ref url="https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/broken-reference/README.md" %}
[https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/broken-reference/README.md](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/broken-reference/README.md)
{% endcontent-ref %}
...
When you purchase a package for push notifications as a self-managed customer, you need to connect your workspace [Rocket.Chat Cloud](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-cloud).
