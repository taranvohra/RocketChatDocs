...
{% content-ref url="https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/broken-reference/README.md" %}
[https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/broken-reference/README.md](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/broken-reference/README.md)
{% endcontent-ref %}
