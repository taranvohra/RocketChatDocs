...
* [Create a user](../users/#add-new-users) with `bot` [role ](https://github.com/taranvohra/RocketChatDocs/blob/master/setup-and-administer-rocket.chat/roles-in-rocket.chat)to be used for the relay.
{% endhint %}
