...
[**Email Inboxes**](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/rocket.chat-workspace-administration/broken-reference/README.md): Learn to manage Omnichannel email inboxes or email accounts for the email channels.
