...
With [https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/rocket.chat-federation](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/rocket.chat-federation "mention") enabled and configured on your Rocket.Chat workspace, you can talk with users on other federated servers.
