...
{% hint style="info" %}
![](<../../.gitbook/assets/Deprecated (1).png>) [Rocket.Chat basic federation](https://github.com/taranvohra/RocketChatDocs/blob/master/use-rocket.chat/workspace-administration/settings/federation/rocket.chat-federation) is deprecated as from Rocket.Chat `6.0.`
